...
class evalPage_AR extends StatefulWidget {
  const evalPage_AR({Key? key}) : super(key: key);

  @override
  State<evalPage_AR> createState() => _evalPage_ARState();
}

class _evalPage_ARState extends State<evalPage_AR> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text('قائمة التقييم للبرنامج وغيرها',
            style: TextStyle(
              fontFamily: 'Tajawal'
            ),
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            final url='https://docs.google.com/forms/d/e/1FAIpQLSf_abCD0_UoBsB1Wu45mnJZiasod53BpUwsTopXUbERo_QZHg/viewform?vc=0&c=0&w=1&flr=0';
                          ...
                          child: Text('قائمة التقييم للبرنامج',
                            textDirection: TextDirection.rtl,
                            style: TextStyle(
                              fontFamily: 'Tajawal',
                              height:1.8,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            final url='https://drive.google.com/file/d/1sQddhgTHRMn_Lsfi_fcO1xz1-bu_pfWd/view?usp=drivesdk';
                            if(await canLaunch(url)){
                              await launch(url);
                            }else if(await canLaunch(url)){
                              await launch(url,
